...
class TrainingModelWrapper:
    ...
    def _load_network_architecture(self, config):
        try:
            ...
            self.network_architecture.load_state_dict(torch.load(self.pretrain, map_location=self.device))
    ...
    def evaluate(self):
        evaluation_metrics = Metrics_Evaluation(self.predict_save_dir, self.test_generator, self.evaluation_metrics_save_dir, self.device)
